...
<ul>
	<li>$$Triplett - The Fishing reel experiment.$$ Boys. Gave fishing reel. Reel the line on the fishing reel as fast as you can. Manipulated variable - alone or with someone else sitting next to them. Shows a classic effect - they reeled in faster when there were two boys than alone. ##Social Facilitation##. </li>
	<li>$$Floyd Allport - the study of attitudes$$. Student of William James. All psychology was looking at behaviourism - what rewards could influence behaviours. He looked at perpensity towards behaviour. Nowadays, attitudes, thoughts, feelings. </li>
	<li>$$Cooley, Mead, &amp; James - theorizing about the social self-concept.$$ Where do we get a sense of self? How do we decide who we are and what we're like? The ##Looking Glass##. The way we figure out what we're like, is seeing how we're seen by other people. Reflection of how other people see us. </li>
	<li>$$Katz &amp; Braly - the study of stereotyping.$$ Princeton students. Here's a list of ethnic groups. 140 adjectives. Which adjectives go with which group? Turks were mean, evil, mercinary. Blacks were described as stupid, lazy, and superstitious. Every group had strong negative stereotypes. Results have changed over the years. </li>
	<li>$$La Pierre - attitudes links to behaviour.$$ Called up 150 restaurants and said he's going to be traveling with a couple that's in Japan, will you let us stay. Everybody said no. He went to each of them and all but 1 served them. People are stereotyping, but they're not following through. Nowadays, they're not stereotyping, but there are stereotyping. Swithc between attitude and behaviour. Not only what people are thinking/saying, but what they're actually doing.</li>
</ul>
...
<ul>
	<li>$$Kurt Lewin$$ - Research Center. </li>
	<li>$$Solomon Asch$$ - Line Judgement studies. Conformity. Understand Nazis. ##Person Perception##. Not perception in objects, but people. How do you perceive another person, how do you decide what they're like? </li>
	<li>$$Fritz Heider$$ - Developed the full expression of Person Perception - ##Attribution Theory##. When you watch somebody, how do you decide what type of person they are? You see people do things - when do you take what they do as reflecting the person they are vs. the situation. <span class="ex">Carla Homocha. How should you think about her? How do you make sense of her? Vicious psychopath or a victim of circumstances?</span> Trying to decide which behaviours tell what this person is really like. </li>
</ul>
	

<h2>The Age of Great Theories and Experiemnts Mid 1940s- Late 1950s</h2>
<ul>
	<li>Asch - ##Conformity##, ##Person Perception##. </li>
	<li>Milgam - Asch's student. ##Obedience##. </li>
	<li>Festinger - Most famous of Kurt Lewin's students. ##Cognitive Dissonance##. Two thoughts that are inconsistent, and that's a strong motivation for behaviour.<br>##Social Comparison## - mathematical theory. Drivne to compare ourselves to other people and that's how we learn about who we are. Everything comes about through comparing ourselves to other people. We don't have a great sense of ourselves until we compare ourselves to other people. </li>
	<li>Heider - ##Balance Theory##. ##Attribution Theory##</li>
</ul>
...
<ul>
	...
	<li>Aggression - Vietnam War. Why is the US fighting this war? What leads to the aggression? <br>##Gun Effect## - presence of guns makes aggression more likely.</li>
	<li>Altruism. ##Bystander Intervention##. </li>
	<li>Interpersonal Relations - ##Attraction##. How do people get along? Romantic relationships. </li>
</ul>

<h2>The Age of Mentalism 1970's</h2>
<p>Social Cognition comes. </p>
<ul>
	<li>The Naive Scientist - How is it that people do things? Why is it they do things? Thought as being the primary cause. People are like naive scientists. People just process information in a very straightforward and ideal way. Lead to ##Attribution Models## devoid of emotions. </li>
	<li>The Cognitive Miser - Maybe not thought, but cognition still motivates. ##Schemas##, ##Heuristics##.</li>
	<li>The Motivated Tactician. ##Accuracy motivation##</li>
</ul>
...
<ul>
	...
	<li>Bartlett's Reaction - ##Schemas## - larger concept that shapes the way you see the world. </li>
...
<ul>
	<li>@@Correlation@@ When one variable changes, theh other variable changes. Not causation until we know the direction it goes on. </li>
	<li>@@Time Order@@ Which one comes first? </li>
	<li>@@Eliminate all other possible cuases@@ Experiemnts are designed to do this. Random assignment cannot be about the type of people. </li>
</ul>
...
<p>Song: Sly &amp; the family stone - everyday people</p>
...
<ul>
	<li>@@The Classical View@@ WRONG. You can define things with necessary and sufficient categories. This is not the way we think. We have a hard time thinking in definitions. We can memorize definitions. DEfinitions are not the way we think - knowing one and being unable to apply it. 
		<ul>Problems: 
	...
	<li>@@The Probabilistic View@@ Bottom up view. What's typical for that category becomes the way to think about it. You get a central idea of what it is from examples. You learn concepts better by having a good example - ##Prototype##. Once you understand the prototype, you cna make much better classification. <span class="ex">The date: both people have shared mutual affection for one other. A kiss is one way to show that, but not the only one (forced kiss does not show this). Oh, this really fits.</span>Central tendency. Family resemblance - similar without being exact. </li>
	<li>@@@@ top-down concept. You have schemas that you're told about, and they affect how you develop concepts. </li>
</ul>

<h2>Two types of Probabilistic Models </h2>
<p>Abstract idea vs. Examples</p>
<ul>
	<li>@@Prorotype Model@@ We have abstract list of features that are typical of category members. Abstracted ideal of what a _____ is. <span class="ex">Think of a used car salesman. Dishonest, slick, persuasive, talk forever, confident, obnoxious. Prototypes don't have to be that far off from stereotypes.</span></li>
	<li>@@Examplar Model@@ No summary, no abstraction. You remember specific instances and store them in memory. You think of particular instances. Sometimes our categories are defined by a particular example. </li>
</ul>
